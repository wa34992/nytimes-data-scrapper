...
from modules import FormatDate, ExcelGenerator
...
class DataExtractor:
    ...
    def __init__(self):
        ...
        self.date_processor = FormatDate()
    ...
    # if 2 then current month and previous month, if 3 then current and previous 2  menths.
    ...
    def get_articles_within_date_range(self, start_date):
        try:
            ...
            for article in articles:
                ...
                article_date = self.date_processor.process_date(date_str)
    ...
    def get_article_data(self, articles, search_phrase):
        ...
        for article in articles:
            ...
            date_element = article.find_element(By.TAG_NAME, "span")
            date_str = date_element.get_attribute("innerHTML")
            date = self.date_processor.process_date(date_str)
